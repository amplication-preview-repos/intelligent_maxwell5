...
@InputType()
class ConversationCreateNestedManyWithoutUserProfilesInput {
...
export { ConversationCreateNestedManyWithoutUserProfilesInput as ConversationCreateNestedManyWithoutUserProfilesInput };
