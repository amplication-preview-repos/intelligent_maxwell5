...
@InputType()
class SessionCreateNestedManyWithoutUserProfilesInput {
...
export { SessionCreateNestedManyWithoutUserProfilesInput as SessionCreateNestedManyWithoutUserProfilesInput };
