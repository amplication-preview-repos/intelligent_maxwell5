...
@InputType()
class ReferralCreateNestedManyWithoutUserProfilesInput {
...
export { ReferralCreateNestedManyWithoutUserProfilesInput as ReferralCreateNestedManyWithoutUserProfilesInput };
